...
typedef cudaError_t CUDARTAPI CudaDeviceSynchronizeFcnTy(void);
static CudaDeviceSynchronizeFcnTy *CudaDeviceSynchronizeFcnPtr;
...
static int initialDeviceAPIsCUDA() {
  ...
  CudaDeviceSynchronizeFcnPtr = (CudaDeviceSynchronizeFcnTy *)getAPIHandleCUDA(
      HandleCudaRT, "cudaDeviceSynchronize");
